...
import 'package:flutterfire_auth/utils/primary_button.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  //static final passKey = new GlobalKey<FormFieldState>();
  ...
  List<Widget> usernameAndPassword() {
    return [
      ...
      padded(child: new TextFormField(
        ...
        obscureText: true,
        autocorrect: false,
        validator: (val) => val != _passController.text? 'Passwords must match' : null,
        /*onSaved: (val) => _password = val*/)) 
        : new Container()
    ];
  }
